...
export default function Header() {
  ...
  // Gestion du clic sur #selected-project pour fermer le menu mobile
  useEffect(() => {
    const selectedProjectLink = document.getElementById("selected-project");

    const handleClick = () => {
      setIsMobileMenuOpen(false); // Ferme le menu quand #selected-project est cliqué
    };

    if (selectedProjectLink) {
      selectedProjectLink.addEventListener("click", handleClick);
    }

    return () => {
      if (selectedProjectLink) {
        selectedProjectLink.removeEventListener("click", handleClick);
      }
    };
  }, []);
