...
export default function ProjectCard({
  ...
  return (
    <a
      ...
      className="inline-flex flex-col dark:bg-white bg-[--color-dark-bg] w-[calc(100svw-48px)] max-w-[560px] rounded-3xl p-3 pb-5 md:w-[60lvw] md:max-w-[632px] md:rounded-[32px] md:p-6 lg:w-[35lvw] transition-all hover:bg-[--color-pink] dark:hover:bg-[--color-pink]"
    >
