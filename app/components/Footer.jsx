  ...
  return (
    <>
      <div className="p-3 md:p-6 lg:p-10 flex flex-col">
        <p className="max-w-[1920px] min-w-full pb-8 font-mono text-[13px] uppercase dark:text-[--color-pink] text-black">
            ...
            <div className="flex w-1/2 flex-col justify-between md:pl-6 lg:w-9/12 lg:flex-row-reverse lg:items-center lg:pl-0">
              <ul className="text-[15px] font-normal leading-[1.1] lg:flex lg:w-full lg:max-w-[440px] lg:justify-between">
                <li className="whitespace-nowrap py-2">
                  <a href="#" className="flex items-center gap-2 lg:hover:underline">
                    <svg width="24px" height="24px" strokeWidth="1.5" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" color="#000000"><path d="M21 8V16C21 18.7614 18.7614 21 16 21H8C5.23858 21 3 18.7614 3 16V8C3 5.23858 5.23858 3 8 3H16C18.7614 3 21 5.23858 21 8Z" stroke="#000000" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"></path><path d="M7 17V13.5V10" stroke="#000000" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"></path><path d="M11 17V13.75M11 10V13.75M11 13.75C11 10 17 10 17 13.75V17" stroke="#000000" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"></path><path d="M7 7.01L7.01 6.99889" stroke="#000000" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"></path></svg>
                    Linkedin
                  </a>
                </li>
                <li className="whitespace-nowrap py-2">
                ...
                <li className="whitespace-nowrap py-2">
                  <a href="#" className="flex items-center gap-2 lg:hover:underline">
                    <svg width="24px" height="24px" viewBox="0 0 24 24" strokeWidth="1.5" fill="none" xmlns="http://www.w3.org/2000/svg" color="#000000"><path d="M16.8198 20.7684L3.75317 3.96836C3.44664 3.57425 3.72749 3 4.22678 3H6.70655C6.8917 3 7.06649 3.08548 7.18016 3.23164L20.2468 20.0316C20.5534 20.4258 20.2725 21 19.7732 21H17.2935C17.1083 21 16.9335 20.9145 16.8198 20.7684Z" stroke="#000000" strokeWidth="1.5"></path><path d="M20 3L4 21" stroke="#000000" strokeWidth="1.5" strokeLinecap="round"></path></svg>
                    Twitter/X
                  </a>
                </li>
              </ul>
